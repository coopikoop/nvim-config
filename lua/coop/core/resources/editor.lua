return {
...

    {
        ...
        keys = {
            ...
            { "<leader>f", require("coop.util").telescope("find_files"), desc = "Find files" },
            -- { "<leader>F",  "<cmd>Telescope live_grep<cr>",                                                   desc = "Find Text" },
            { "<leader>F", require("coop.util").telescope("live_grep"), desc = "Find Text" },
        },
        -- config = function() require("coop.config.telescope") end,
    },
